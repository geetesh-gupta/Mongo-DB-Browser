...
public class EnableAggregateAction extends ToggleAction implements DumbAware {
	...
	private static final String QUERY_AGGREGATION_SAMPLE =
			"ex: [{'$match': {'name': 'foo'}, {'$project': {'address': 1}}]";
	...
	@Override
	public void setSelected(@NotNull AnActionEvent event, boolean enableAggregation) {
