...
class CopyAllAction(private val mongoResultPanel: MongoResultPanel) :
    AnAction("Copy Results", "Copy results to clipboard", AllIcons.Actions.Copy), DumbAware {
    override fun actionPerformed(anActionEvent: AnActionEvent) {
        CopyPasteManager.getInstance().setContents(StringSelection(mongoResultPanel.stringifiedResult))
    }
}